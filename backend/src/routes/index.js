...
router.use('/goals', authenticate, require('./goal.routes'));
router.use('/reminders', authenticate, require('./reminder.routes'));
router.use('/service-requests', authenticate, require('./service-request.routes'));
router.use('/integration', authenticate, require('./integration.routes'));
